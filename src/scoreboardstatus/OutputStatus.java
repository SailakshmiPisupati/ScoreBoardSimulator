...
public class OutputStatus {
	...
	private static void showOutput() {
		...
		System.out.println("Total number of access requests for instruction cache "+ Fetch.ifetched);
	...
	public static void writeToOutputFile()throws IOException {
		...
		int icachehits = Collections.frequency(Fetch.icachehits.values(), true);
		fw.write("--------------------------------------------------------------------------\n");
		fw.write("Total number of access requests for instruction cache "+ Fetch.ifetched+"\n");
