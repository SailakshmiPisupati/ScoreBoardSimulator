...
public class ANDI extends Instruction{
	...
	public ANDI(Register register_operand1, Register register_operand2, Immediates immediate_operand) {
		super();
	...
	public void execute() throws Exception {
		double value = (int) RegisterStatus.read(this.register_operand2) & (int) this.immediate_operand.value;
