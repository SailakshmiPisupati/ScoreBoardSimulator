...
public class ANDI extends Instruction{
	...
	public ANDI(Register destinationRegister, Register sourceRegister1, Immediates immediateOperand) {
		super();
	...
	public void execute() throws Exception {
		double value = (int) RegisterStatus.read(this.sourceRegister1) & (int) this.immediateOperand.value;
